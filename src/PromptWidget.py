from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QTextEdit, QGridLayout, QGroupBox, QPushButton
...
class PromptWidget(QWidget):
    ...
    def __init__(self, parent=None): 
        ...
        self.serial_data_viewer.viewer_closed.connect(self.PButton_SerialDataViewer.toggle)
