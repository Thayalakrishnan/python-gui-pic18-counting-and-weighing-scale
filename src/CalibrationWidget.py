...
from CommandButton import  Command, MultiCommandButton, CalibrationCommands, CommandButton
...
class CalibrationWidget(QWidget):
    ...
    def setupStates(self):
        ...
        self.state_start.addTransition(self.Calibration_Button.clicked, self.state_calibrate)
        self.state_start.addTransition(self.Tare_Button.clicked, self.state_tare)
        
        self.state_calibrate.addTransition(self.response.calibration_complete, self.state_start)
        self.state_tare.addTransition(self.response.calibration_complete, self.state_start)
